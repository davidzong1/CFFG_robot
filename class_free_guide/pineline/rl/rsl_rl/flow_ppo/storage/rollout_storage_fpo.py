...
from class_free_guide.pineline.rl.rsl_rl.flow_ppo.utils.utils import split_and_pad_trajectories
...
class RolloutStorage:
    ...
    def __init__(
        ...
        self.x1_pred = torch.zeros(num_transitions_per_env, num_envs, n_samples_per_action, *actions_shape, device=self.device)
