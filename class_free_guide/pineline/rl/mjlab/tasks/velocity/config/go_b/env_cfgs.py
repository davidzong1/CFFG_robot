...
from .....asset.robots.go_b.param import (
    get_go_b_robot_cfg,
)
...
def robot_go_b_rough_env_cfg(
    play: bool = False,
) -> ManagerBasedRlEnvCfg:
    """Create Unitree GO_B rough terrain velocity configuration."""
    cfg = make_velocity_env_cfg()

    cfg.sim.mujoco.ccd_iterations = 500
    cfg.sim.contact_sensor_maxmatch = 500

    cfg.scene.entities = {"robot": get_go_b_robot_cfg()}

    # Set raycast sensor frame to GO_B base_link.
...
def unitree_go2_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    ...
    cfg = robot_go_b_rough_env_cfg(play=play)
