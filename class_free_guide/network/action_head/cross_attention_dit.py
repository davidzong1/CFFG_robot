...
class DiT(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        for idx, block in enumerate(self.transformer_blocks):
            # Cross attention in even blocks, self attention in odd blocks (if interleave_self_attention is True)
            # To Avoid performing cross-attention on every layer and reduce direct dependence on the encoder
